...
import "github.com/Coder8124/logos/internal/session"
...
func (b *Logos) Note(project, text string) error {
...
// mid-task.
func (b *Logos) Notes(project string) ([]Note, error) {
...
func (b *Logos) Checkpoint(c Checkpoint) (string, error) {
	if c.Agent == "" {
		c.Agent = b.agent
	}
...
func (b *Logos) History(project string, n int) ([]Checkpoint, error) {
